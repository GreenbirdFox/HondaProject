...
from py.imagePro_newGui import imageprocess_top,imageprocess_bottom
...
def call_chart(loc,n1,camera_loc):
    ...
    chart_dir= os.path.join(out_dir, chart_dir)
    chart_path1=chart_dir+loc+"-"+camera_loc+"-hotelling-chart.png"
    ...
    chart_path2=chart_dir+loc+"-"+camera_loc+"-EWMA-chart.png"
...
msg = Label(root, text = "Welcome to SEAL Vision V1.0 Measurement Application!",font=title_font0).place(x=100,y=30)
...
label_Pred = tk.Label(root,text='Gap & Flush prediction',font=title_font1).place(x=30,y=280)
...
bc0 = tk.Button(root,text = "All",command=call_plotA,activeforeground = "red",activebackground = "pink").place(x = 120, y = 780)  
